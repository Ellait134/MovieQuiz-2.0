...
public class Level1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Диалоговое окно начало ур.1 - Начало
        ...
        //Диалоговое окно начало ур1. - конец

        //Диалоговое окно конец ур1. - Начало
        ...
        //Диалоговое окно конец ур1. - Конец
        ...
        img1.setImageResource(array.images1[num1]);

        num2 = random.nextInt(10);
        img2.setImageResource(array.images1[num2]);

        num3 = random.nextInt(10);
        img3.setImageResource(array.images1[num3]);

        num4 = random.nextInt(10);
        img4.setImageResource(array.images1[num4]);
        ...
        text1.setText(array.texts1[num1]);
