...
public class Level5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Диалоговое окно начало ур.5 - Начало
        ...
        previewimg.setImageResource(R.drawable.previewgamefive);
        ...
        //Диалоговое окно начало ур5. - конец

        //Диалоговое окно конец ур5. - Начало
        ...
        textdescriptionEnd.setText(R.string.lvlfive);
        ...
        img1.setImageResource(array.images5[num1]);

        num2 = random.nextInt(10);
        img2.setImageResource(array.images5[num2]);

        num3 = random.nextInt(10);
        img3.setImageResource(array.images5[num3]);

        num4 = random.nextInt(10);
        img4.setImageResource(array.images5[num4]);
        ...
        text1.setText(array.texts5[num1]);
