...
public class Level2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Диалоговое окно начало ур.2 - Начало
        ...
        //Диалоговое окно начало ур2. - конец

        //Диалоговое окно конец ур2. - Начало
        ...
        textdescriptionEnd.setText(R.string.lvltwo);
        ...
        //Диалоговое окно конец ур2. - Конец
        ...
        img1.setImageResource(array.images2[num1]);

        num2 = random.nextInt(10);
        img2.setImageResource(array.images2[num2]);

        num3 = random.nextInt(10);
        img3.setImageResource(array.images2[num3]);

        num4 = random.nextInt(10);
        img4.setImageResource(array.images2[num4]);
        ...
        text1.setText(array.texts2[num1]);
